...
\appendix
\section{Resultados completos por instancia}
\label{apx:tabla}

La Tabla~\ref{tab:hhs} detalla el BKS de cada metaheur\'istica en
las 31 instancias. Los valores en \textbf{negrita} corresponden al
mejor resultado entre las siete metaheur\'isticas del protocolo
com\'un (excl.\ HHS*).
